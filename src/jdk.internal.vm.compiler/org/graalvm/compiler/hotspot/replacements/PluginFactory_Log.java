...
//        class: org.graalvm.compiler.hotspot.replacements.Log
...
public class PluginFactory_Log implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_Log_log__0(injection), org.graalvm.compiler.hotspot.replacements.Log.class, "log", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, java.lang.Object.class, boolean.class, boolean.class);
        plugins.register(new Plugin_Log_log__1(injection), org.graalvm.compiler.hotspot.replacements.Log.class, "log", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, int.class, long.class, boolean.class);
        plugins.register(new Plugin_Log_printf(injection), org.graalvm.compiler.hotspot.replacements.Log.class, "printf", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, org.graalvm.compiler.word.Word.class, long.class, long.class, long.class);
    }
}
