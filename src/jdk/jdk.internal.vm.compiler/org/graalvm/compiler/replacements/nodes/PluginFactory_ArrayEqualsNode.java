...
final class Plugin_ArrayEqualsNode_equals extends GeneratedInvocationPlugin {
    ...
    Plugin_ArrayEqualsNode_equals(NodeIntrinsicPluginFactory.InjectionProvider injection) {
...
public class PluginFactory_ArrayEqualsNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_ArrayEqualsNode_equals(injection), org.graalvm.compiler.replacements.nodes.ArrayEqualsNode.class, "equals", java.lang.Object.class, java.lang.Object.class, int.class, jdk.vm.ci.meta.JavaKind.class);
    }
}
