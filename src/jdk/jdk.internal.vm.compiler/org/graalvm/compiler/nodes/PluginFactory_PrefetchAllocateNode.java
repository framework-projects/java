...
final class Plugin_PrefetchAllocateNode_prefetch extends GeneratedInvocationPlugin {
...
public class PluginFactory_PrefetchAllocateNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_PrefetchAllocateNode_prefetch(), org.graalvm.compiler.nodes.PrefetchAllocateNode.class, "prefetch", org.graalvm.compiler.nodes.memory.address.AddressNode.Address.class);
    }
}
