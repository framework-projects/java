...
final class Plugin_MemoryAnchorNode_anchor extends GeneratedInvocationPlugin {
...
public class PluginFactory_MemoryAnchorNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_MemoryAnchorNode_anchor(), org.graalvm.compiler.nodes.memory.MemoryAnchorNode.class, "anchor");
    }
}
