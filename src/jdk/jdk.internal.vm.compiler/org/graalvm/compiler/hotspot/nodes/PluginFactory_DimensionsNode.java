...
public class PluginFactory_DimensionsNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_DimensionsNode_allocaDimsArray(injection), org.graalvm.compiler.hotspot.nodes.DimensionsNode.class, "allocaDimsArray", int.class);
    }
}
