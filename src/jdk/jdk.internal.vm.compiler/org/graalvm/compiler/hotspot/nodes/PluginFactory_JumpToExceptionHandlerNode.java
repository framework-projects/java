...
final class Plugin_JumpToExceptionHandlerNode_jumpToExceptionHandler extends GeneratedInvocationPlugin {
...
public class PluginFactory_JumpToExceptionHandlerNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_JumpToExceptionHandlerNode_jumpToExceptionHandler(), org.graalvm.compiler.hotspot.nodes.JumpToExceptionHandlerNode.class, "jumpToExceptionHandler", org.graalvm.compiler.word.Word.class);
    }
}
