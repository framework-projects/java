...
final class Plugin_PatchReturnAddressNode_patchReturnAddress extends GeneratedInvocationPlugin {
...
public class PluginFactory_PatchReturnAddressNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_PatchReturnAddressNode_patchReturnAddress(), org.graalvm.compiler.hotspot.nodes.PatchReturnAddressNode.class, "patchReturnAddress", org.graalvm.compiler.word.Word.class);
    }
}
