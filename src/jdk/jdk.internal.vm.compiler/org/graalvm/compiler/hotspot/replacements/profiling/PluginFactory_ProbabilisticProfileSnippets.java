...
final class Plugin_ProbabilisticProfileSnippets_methodBackedgeEvent extends GeneratedInvocationPlugin {
    ...
    Plugin_ProbabilisticProfileSnippets_methodBackedgeEvent(NodeIntrinsicPluginFactory.InjectionProvider injection) {
...
// generated-by: org.graalvm.compiler.replacements.processor.GeneratedNodeIntrinsicPlugin$CustomFactoryPlugin
final class Plugin_ProbabilisticProfileSnippets_methodInvocationEvent extends GeneratedInvocationPlugin {
    ...
    Plugin_ProbabilisticProfileSnippets_methodInvocationEvent(NodeIntrinsicPluginFactory.InjectionProvider injection) {
        this.injectedForeignCallsProvider = injection.getInjectedArgument(org.graalvm.compiler.core.common.spi.ForeignCallsProvider.class);
        this.snippetReflection = injection.getInjectedArgument(org.graalvm.compiler.api.replacements.SnippetReflectionProvider.class);
        this.stamp = injection.getInjectedStamp(void.class, false);
    }
...
public class PluginFactory_ProbabilisticProfileSnippets implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_ProbabilisticProfileSnippets_methodBackedgeEvent(injection), org.graalvm.compiler.hotspot.replacements.profiling.ProbabilisticProfileSnippets.class, "methodBackedgeEvent", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, org.graalvm.compiler.hotspot.word.MethodCountersPointer.class, int.class, int.class);
        plugins.register(new Plugin_ProbabilisticProfileSnippets_methodInvocationEvent(injection), org.graalvm.compiler.hotspot.replacements.profiling.ProbabilisticProfileSnippets.class, "methodInvocationEvent", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, org.graalvm.compiler.hotspot.word.MethodCountersPointer.class);
    }
}
