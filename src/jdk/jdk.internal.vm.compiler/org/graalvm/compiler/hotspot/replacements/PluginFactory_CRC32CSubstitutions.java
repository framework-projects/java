...
final class Plugin_CRC32CSubstitutions_updateBytesCRC32 extends GeneratedInvocationPlugin {
    ...
    Plugin_CRC32CSubstitutions_updateBytesCRC32(NodeIntrinsicPluginFactory.InjectionProvider injection) {
...
public class PluginFactory_CRC32CSubstitutions implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_CRC32CSubstitutions_updateBytesCRC32(injection), org.graalvm.compiler.hotspot.replacements.CRC32CSubstitutions.class, "updateBytesCRC32", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, int.class, jdk.internal.vm.compiler.word.WordBase.class, int.class);
    }
}
