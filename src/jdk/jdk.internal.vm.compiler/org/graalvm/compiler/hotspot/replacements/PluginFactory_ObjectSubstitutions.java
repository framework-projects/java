...
final class Plugin_ObjectSubstitutions_fastNotifyStub extends GeneratedInvocationPlugin {
    ...
    Plugin_ObjectSubstitutions_fastNotifyStub(NodeIntrinsicPluginFactory.InjectionProvider injection) {
...
public class PluginFactory_ObjectSubstitutions implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_ObjectSubstitutions_fastNotifyStub(injection), org.graalvm.compiler.hotspot.replacements.ObjectSubstitutions.class, "fastNotifyStub", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, java.lang.Object.class);
    }
}
