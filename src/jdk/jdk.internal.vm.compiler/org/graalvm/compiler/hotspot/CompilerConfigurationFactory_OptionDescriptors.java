    ...
    public OptionDescriptor get(String value) {
        ...
        case "CompilerConfiguration": {
            return OptionDescriptor.create(
                ...
                /*help*/ "Names the compiler configuration to use. If omitted, the compiler configuration with the highest auto-selection priority is used. To see the set of available configurations, supply the value 'help' to this option.",
        ...
        case "ShowConfiguration": {
            return OptionDescriptor.create(
                ...
                /*help*/ "Writes to the VM log information about the compiler configuration selected.",
                /*declaringClass*/ CompilerConfigurationFactory.Options.class,
