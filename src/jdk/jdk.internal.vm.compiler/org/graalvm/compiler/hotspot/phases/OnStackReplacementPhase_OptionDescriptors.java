    ...
    public OptionDescriptor get(String value) {
        ...
        case "SupportOSRWithLocks": {
            return OptionDescriptor.create(
                ...
                /*optionType*/ OptionType.Debug,
                /*optionValueType*/ Boolean.class,
                /*help*/ "Support OSR compilations with locks. If DeoptAfterOSR is true we can per definition not have unbalanced enter/exits mappings. If DeoptAfterOSR is false insert artificial monitor enters after the OSRStart to have balanced enter/exits in the graph.",
                /*declaringClass*/ OnStackReplacementPhase.Options.class,
